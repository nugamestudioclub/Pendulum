...
namespace Utils
{
    ...
    public class CallAccessorsAttributeDrawer : PropertyDrawer
    {
        ...
        private static void DrawPropertyGUI(Rect position, string name, SerializedProperty property,
            PropertyInfo propertyInfo, GUIContent label)
        {
        ...
        private static object GetValueFromGUI(Rect position, SerializedProperty property, PropertyInfo propertyInfo,
            object value, GUIContent label)
        {
            return property.propertyType switch
            {
                ...
                SerializedPropertyType.ObjectReference => EditorGUI.ObjectField(position, label,
                    (UnityEngine.Object)value, propertyInfo.PropertyType, true),
                ...
                SerializedPropertyType.ExposedReference => EditorGUI.ObjectField(position, label,
                    (UnityEngine.Object)value, propertyInfo.PropertyType, true),
                ...
                SerializedPropertyType.ManagedReference => EditorGUI.ObjectField(position, label,
                    (UnityEngine.Object)value, propertyInfo.PropertyType, true),
                // missing Hash128
